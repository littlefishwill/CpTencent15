...
import com.lfish.lotterysscjh.net.novate.service.BaseApiService;
import com.lfish.lotterysscjh.net.novate.util.Utils;
...
/**
 * Rxjava 解释：http://gank.io/post/560e15be2dca930e00da1083
 * 源码地址：https://github.com/NeglectedByBoss/Novate
 * OKhttp ：http://square.github.io/okhttp/
 * rxjava ：https://github.com/ReactiveX/RxJava 源码
 * <p>
 * RetrofitClient adapts a Java interface to Retrofit call by using annotations on the declared methods to
 * define how requests are made. Create instances using {@linkplain Builder
 * the builder} and pass your interface to {@link #} to generate an implementation.
 * <p/>
 * For example,
 * <pre>{@code
 * RetrofitClient novate = new RetrofitClient.Builder()
 *     .baseUrl("http://api.example.com")
 *     .addConverterFactory(GsonConverterFactory.create())
 *     .build();
 * <p/>
 * MyApi api = RetrofitClient.create(MyApi.class);
...
public final class RetrofitClient {
    ...
    /**
     * Mandatory constructor for the RetrofitClient
     */
    RetrofitClient(okhttp3.Call.Factory callFactory, String baseUrl, Map<String, String> headers,
     ...
     */
    public <T> T executeGet(String url, Map<String, String> maps, ResponseCallBack<T> callBack) {
        ...
        Type NeedType = MethodHandler(types).get(0);
        Log.d("dd", "-->:" + "Type:" + types[0]);


        apiManager.executeGet(url, maps)
                .compose(schedulersTransformer)
                .subscribe(new NovateSubscriber<T>(mContext, NeedType, callBack));
        return null;
     ...
     * you don't need to   parse ResponseBody
     */
    public <T> T executePost(String url, Map<String, String> maps, ResponseCallBack<T> callBack) {
        Type[] types = callBack.getClass().getGenericInterfaces();
     ...
     * you don't need to   parse ResponseBody
     */
    public <T> T executeDelete(String url, Map<String, String> maps, ResponseCallBack<T> callBack) {
        Type[] types = callBack.getClass().getGenericInterfaces();
     ...
     * you don't need to parse ResponseBody
     */
    public <T> T executePut(String url, Map<String, String> maps, ResponseCallBack<T> callBack) {
        Type[] types = callBack.getClass().getGenericInterfaces();
    ...
    public static class Builder {
        ...
        private static int DEFAULT_MAXIDLE_CONNECTIONS = 5;
        private static long DEFAULT_KEEP_ALIVEDURATION = 8;
        private static long caheMaxSize = 10 * 1024 * 1024;
         ...
         *//*
        public Builder addApiManager( Class<ApiManager> service) {
         ...
         * @return
         */
        public Builder addCacheAge(Cache cache, int cacheTime) {
         ...
         * @return
         */
        public Builder addCacheStale(Cache cache, int cacheTime) {
         ...
         * @return
         */
        public Builder addCache(Cache cache, String cacheControlValue) {
        ...
        public RetrofitClient build() {
            ...
            if (sslSocketFactory != null) {
                okhttpBuilder.socketFactory(sslSocketFactory);
            }
             ...
             * outgoing HTTP requests.
             *
             * <p>If unset, {@link RetrofitClient CookieManager#NO_COOKIES no cookies} will be accepted nor provided.
             */
            ...
            return new RetrofitClient(callFactory, baseUrl, headers, parameters, apiManager, converterFactories, adapterFactories,
    ...
    class NovateSubscriber<T> extends BaseSubscriber<ResponseBody> {
        ...
        public NovateSubscriber(Context context, Type NeedType, ResponseCallBack<T> callBack) {
            super(context);
            ...
            try {
                ...
                if (callBack != null) {
                    try {
                         ...
                         *
                         *  callBack.onSuccee((T) JSON.parseArray(jsStr, (Class<Object>) NeedType));
                         *  Type NeedType = needChildType;
                         */

                        NovateResponse<T> baseResponse = new Gson().fromJson(jsStr, NeedType);

                        if (baseResponse.isOk()) {
                            callBack.onSuccee((T) new Gson().fromJson(jsStr, NeedType));
                        }
