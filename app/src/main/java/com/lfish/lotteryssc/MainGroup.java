...
import com.lfish.lotteryssc.dao.TabDao;
import com.lfish.lotteryssc.fragment.ChartFragment;
import com.lfish.lotteryssc.fragment.NewsFragment;
import com.lfish.lotteryssc.fragment.OpenCodeFragment;
import com.lfish.lotteryssc.fragment.PlannFragment;
import com.lfish.lotteryssc.fragment.UsFragment;
import com.lfish.lotteryssc.fragment.adapter.FragmentAdapter;
...
//        vp_view_page_image.setAdapter(adapter);
//
...
//        list.add(new OpenCodeFragment());
//        list.add(new NewsFragment());
//        list.add(new NewsFragment());
//        list.add(new NewsFragment());
//        list.add(new NewsFragment());
////        list.add(new UsFragment());
...
//
        ...
        Intent intentThrid =new Intent(getApplicationContext(),NewsActivity.class);
...
//        tabDaos.add(new TabDao("开奖记录",R.drawable.ico_history_n,R.drawable.ico_history_s));
        ...
        tabDaos.add(new TabDao("彩讯",R.drawable.ico_news_normal,R.drawable.ico_news_sel));
